...
interface BulkDeleteAccountProps {
	ids: number[];
	onDeleted?: () => void | Promise<void>;
}

export function BulkDeleteAccount(props: BulkDeleteAccountProps) {
				...
				<Dialog.Positioner>
					<Dialog.Content className="min-w-120 max-w-120">
						<Dialog.Header>
							...
							<div>
								<Dialog.Title>Delete admins</Dialog.Title>
								<Dialog.Description>
