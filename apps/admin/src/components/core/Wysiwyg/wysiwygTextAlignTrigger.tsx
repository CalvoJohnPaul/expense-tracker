...
export const TextAlignTrigger = forwardRef<HTMLButtonElement, WysiwygTextAlignTriggerProps>(
	(props, ref) => {
		const wysiwyg = useWysiwygContext();

		const [textAlignProps, localProps] = useMemo(() => splitProps(props, 'textAlign'), [props]);
